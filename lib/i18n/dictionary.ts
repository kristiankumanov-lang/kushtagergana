...
const bg: Dictionary = {
  ...
  kitchen: {
    ...
    paragraphs: [
      ...
      "Работим с винаги пресни и, където е възможно, домашни продукти. Няма менюта с петдесет ястия, има вкус, който помните.",
    ],
    ...
    freshNote: "Винаги пресни и, където е възможно, домашни продукти.",
  },
  gallery: {
